...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(138),p=__webpack_require__(4),v=__webpack_require__(7),da=__webpack_require__(139),ea=__webpack_require__(140),fa=__webpack_require__(141),ha=__webpack_require__(6);
...
var _Scheduler = _interopRequireDefault(__webpack_require__(148));
...
var _reactFlipMove = _interopRequireDefault(__webpack_require__(149));

var _Spinner = _interopRequireDefault(__webpack_require__(150));

var _Task = _interopRequireDefault(__webpack_require__(152));

var _stylesM = _interopRequireDefault(__webpack_require__(168));

var _REST = __webpack_require__(169);
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_completeAllTasksAsync", async () => {
      ...
      try {
        ...
        await _REST.api.completeAllTasks(uncompletedTasks);
        this.setState(({
          tasks
        }) => ({
  ...
  render() {
    ...
    let filteredTasks = tasks; // Apply search result
    ...
    const tasksJSX = filteredTasks.map(task => _react.default.createElement(_Task.default, _extends({}, task, {
    ...
    }), _react.default.createElement("main", null, _react.default.createElement("header", null, _react.default.createElement("h1", null, "Awesome TO-DO App"), _react.default.createElement("input", {
      placeholder: "Search",
      type: "search",
    ...
    }), _react.default.createElement("button", null, "Add new")), _react.default.createElement("div", {
      className: "overlay"
...
var _classnames = _interopRequireDefault(__webpack_require__(153));

var _stylesM = _interopRequireDefault(__webpack_require__(154));

var _Checkbox = _interopRequireDefault(__webpack_require__(8));

var _Star = _interopRequireDefault(__webpack_require__(165));

var _Edit = _interopRequireDefault(__webpack_require__(166));

var _Remove = _interopRequireDefault(__webpack_require__(167));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "_updateTask", task => {
      const {
        _updateTaskAsync
      } = this.props;
    ...
    _defineProperty(this, "_setTaskEditingState", state => {
      if (state === true) {
        this.setState({
          isTaskEditing: state
    ...
    _defineProperty(this, "_getTaskStyles", () => {
      const {
        completed
      } = this.props;
      return (0, _classnames.default)(_stylesM.default.task, {
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.a11b4.js.map